...
import BDflag from '../../../public/flag images/Flag_of_Bangladesh.svg.png'
import ENGflag from '../../../public/flag images/british-flag-original-colors-proportions-vector-illustration-eps-10_148553-484.avif'
...
const Home = () => {
  ...
  return (
    <div
      className={`${
        !isChecked ? "bg-[#E9D5A1]" : "bg-[#01162B] text-white"
      } h-[90vh] w-full grid place-items-center`}
    >
      {/*  */}
      <div className="items text-center mb-10 mt-20">
        {/*  */}
        <div className="grid place-items-center mb-3">
          <FaLaptopCode
            className={`${
              !isChecked ? "text-[#353239]" : "text-white"
        ...
        <div className="name mb-3">
          <h2
            className={`${
              !isChecked ? "text-[#353239] text-4xl" : "text-white text-4xl"
        ...
        {/*  */}
        <div className="animationType grid place-items-center text-center  uppercase mb-3">
          <TypeAnimation
            className="font-thin"
            sequence={[
        ...
        <div className="darktheme ">
          <label className="themeSwitcherThree relative inline-flex cursor-pointer select-none items-center">
            ...
            <div className="shadow-card flex h-[46px] w-[96px] items-center justify-center rounded-3xl gap-3 duration-75 bg-white">
              <span
...
<div className="language gap-4  grid grid-cols-2 place-items-center ">
                
                 <div className="BDflag ">
                  <button><img className="h-8 border-2 border-white rounded" src={BDflag} alt="" /></button>
                  </div>
                  <div className="ENGflag  ">
                  <button><img className="h-8 border-2 border-white rounded" src={ENGflag} alt="" /></button>
                  </div>
